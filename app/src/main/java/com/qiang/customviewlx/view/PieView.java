...
public class PieView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String title = "饼图";
        float titleWith = paint.measureText(title);
        canvas.drawText(title, rectFWith - titleWith /2, getWidth() * 1.7f/ 8 + rectFWith, paint);
     ...
     //   float horizontalWith = ViewUtil.dip2px(getContext(), 30);
        ...
        float yellowTextWith = paint.measureText("yellow");
        float[] yellowPoint = {yellowPointStartX, yellowPointStartY, yellowPointEndX, yellowPointEndY, yellowPointEndX, yellowPointEndY, yellowPointEndX + yellowTextWith, yellowPointEndY};
        canvas.drawLines(yellowPoint, paint);
        canvas.drawText("yellow", yellowPointEndX, yellowPointEndY - 10, paint);
        ...
        float blueTextWith = paint.measureText("blue");
        float[] bluePoint = {bluePointStartX, bluePointStartY, bluePointEndX, bluePointEndY, bluePointEndX, bluePointEndY, bluePointEndX + blueTextWith, bluePointEndY};
        canvas.drawLines(bluePoint, paint);
        canvas.drawText("blue", bluePointEndX, bluePointEndY - 10, paint);
        ...
        float greenTextWith = paint.measureText("green");
        float[] greenPoint = {greenPointStartX, greenPointStartY, greenPointEndX, greenPointEndY, greenPointEndX, greenPointEndY, greenPointEndX - greenTextWith, greenPointEndY};
        canvas.drawLines(greenPoint, paint);
        canvas.drawText("green", greenPointEndX - greenTextWith, greenPointEndY - 10, paint);
        ...
        float redTextWith = paint.measureText("red");
        float[] redPoint = {redPointStartX, redPointStartY, redPointEndX, redPointEndY, redPointEndX, redPointEndY, redPointEndX - redTextWith, redPointEndY};
        canvas.drawLines(redPoint, paint);
        canvas.drawText("red", redPointEndX - redTextWith, redPointEndY - 10, paint);
    }
}
